function [bbox angles joints] = DetectStillVideo3(obj, ground_truth, pffubfmodel_path,facemodel_path,det_pars,verbose)
  ...
  %% Additional Code
   ...
   if(~size(bbox,1)==0)
       for j=1:size(bbox,1)
           ...
           if (min(similarity)<140)
               text('units','pixels','position',[100 100],'fontsize',60,'string','SUSPICIOUS!')
           end
           pause;
       end
   end
